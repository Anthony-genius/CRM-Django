...
class Requirement(models.Model):
    ...
    system_price = models.IntegerField(null=True, blank=True)
    extra_amount = models.IntegerField(null=True, blank=True)
    total_price = models.IntegerField(null=True, blank=True)
    deposit_amount = models.IntegerField(null=True, blank=True)
    last_amount = models.IntegerField(null=True, blank=True)
    ...
    installer_amount = models.IntegerField(null=True, blank=True)
    ...
    stc_amount_payment = models.IntegerField(null=True, blank=True)
    stc_notes = models.CharField(max_length=500, null=True, blank=True)
    STC_PAYMENT = models.IntegerField(null=True, blank=True)

    stc_amount = models.IntegerField(null=True, blank=True)
    ...
    last_amount_payment = models.IntegerField(null=True, blank=True)
    ...
    last_amount_balance_due =  models.IntegerField(null=True, blank=True)
...
class Supplier(models.Model):
    ...
    supplier_amount = models.IntegerField(null=True, blank=True)
...
class BookImageScrap(models.Model):
